...
>
	...
	<p class="text-gray-500 dark:text-gray-400 text-sm grow leading-relaxed">{description}</p>
	
	<div class="mt-6 flex items-center text-sm font-medium text-purple-600 dark:text-purple-400 opacity-0 transform -translate-x-2.5 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
		Enter Portal
